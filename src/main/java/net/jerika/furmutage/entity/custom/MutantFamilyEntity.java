...
public abstract class MutantFamilyEntity extends PathfinderMob implements Enemy {
    protected MutantFamilyEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    protected void setAttributes(AttributeMap attributes) {
        super.setAggressive(attackable());
        ...
        attributes.getInstance(Attributes.MAX_HEALTH).setBaseValue(120);
    }
    @Nullable
    @Override
